 ...
 */
var BshbUtils = /** @class */ (function () {
    function BshbUtils() {
    }
    /**
     * Generate a client certificate for communication with BSHC
     */
    BshbUtils.generateClientCertificate = function () {
        return selfsigned_1.default.generate(null, { keySize: 2048, clientCertificate: false, algorithm: 'sha256' });
    };
    /**
     * Generate a random identifier which is needed during pairing process.
     */
    BshbUtils.generateIdentifier = function () {
        return uuid_1.default.v4();
    };
    /**
     * Get root ca certificate of Bosch Smart Home Controller.
     */
    BshbUtils.getBoschSmartHomeControllerRootCa = function () {
